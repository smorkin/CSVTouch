...
- (NSString *) textForHelpPage:(NSInteger)index
{
    ...
    switch(index)
    {
        ...
        case 4:
            return  [NSString stringWithFormat:@"If you connect your device to your computer, you can add CSV files directly the same way you add files to any iOS app: Select the device, go to 'Files', select %@, and add the files.", appName];
        case 5:
